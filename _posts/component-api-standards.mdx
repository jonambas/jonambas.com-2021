...
Component props should be rarely spread to an underlying DOM element directly without being picked or altered. This can pollute the DOM with unwanted and unknown props, and produces bugs.
